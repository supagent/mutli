...
RETURNING id, task_id, seq, type, tool, content, input, output, created_at, agent_name
`
...
SELECT id, task_id, seq, type, tool, content, input, output, created_at, agent_name FROM task_message
WHERE task_id = $1
ORDER BY seq ASC
`
