...
LATEST=$(curl -sI https://github.com/supagent/mutli/releases/latest \
  | grep -i '^location:' | sed 's/.*tag\///' | tr -d '\r\n')

# Download and extract
curl -sL "https://github.com/supagent/mutli/releases/download/${LATEST}/multica_${OS}_${ARCH}.tar.gz" \
