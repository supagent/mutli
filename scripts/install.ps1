...
#   $env:MULTICA_MODE="local"; irm https://raw.githubusercontent.com/supagent/mutli/main/scripts/install.ps1 | iex
#
...
# Configuration
# ---------------------------------------------------------------------------
$RepoUrl       = "https://github.com/supagent/mutli.git"
$RepoWebUrl    = "https://github.com/supagent/mutli"
...
function Get-LatestVersion {
    try {
        $release = Invoke-RestMethod -Uri "https://api.github.com/repos/supagent/mutli/releases/latest" -ErrorAction Stop
...
function Install-CliBinary {
    ...
    $url = "https://github.com/supagent/mutli/releases/download/$latest/multica_windows_$arch.zip"
    ...
    $checksumUrl = "https://github.com/supagent/mutli/releases/download/$latest/checksums.txt"
    try {
...
function Start-DefaultInstall {
    ...
    Write-Host '     $env:MULTICA_MODE="with-server"; irm https://raw.githubusercontent.com/supagent/mutli/main/scripts/install.ps1 | iex'
    Write-Host ""
}
...
function Start-LocalInstall {
    ...
    Write-Host '     $env:MULTICA_MODE="stop"; irm https://raw.githubusercontent.com/supagent/mutli/main/scripts/install.ps1 | iex'
    Write-Host ""
}
